...
# Add the graph_view module to the current environment if it does not already exist
import imp
try:
    imp.find_module('graph_view')
    found = True
except ImportError:
    import os, sys
...
from graph_view.port import InputPort, OutputPort, IOPort
