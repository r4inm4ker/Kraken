kl2dfg -polyThis KrakenAnimation.fpm.json /c/temp/KrakenAnimation/ 
cp /c/temp/KrakenAnimation/Func/* ../../Presets/DFG/Kraken/KrakenAnimation/KrakenClip/
cp /c/temp/KrakenAnimation/KrakenClipContext/* ../../Presets/DFG/Kraken/KrakenAnimation/KrakenClipContext/
cp /c/temp/KrakenAnimation/KrakenStaticClip/* ../../Presets/DFG/Kraken/KrakenAnimation/KrakenStaticClip/
