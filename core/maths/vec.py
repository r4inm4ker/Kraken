...
from kraken_core import KrakenCore as KC
...
class Vec2(MathObject):
    ...
    def set(self, x, y):
        self.rtval.set(KC.inst().rtVal('Scalar', x), KC.inst().rtVal('Scalar', x))
    ...
    # def Vec2 * (Scalar a, Vec2 b):

    # # Multiplies a vector and a scalar
    # def Vec2 * (Vec2 a, Scalar b):
    ...
    def add(self, other):
        return self.rtval.add('Vec2', other.rtval)

    # Overload method for the subtract operator
    def subtract(self, other):
        return self.rtval.subtract('Vec2', other.rtval)

    # Overload method for the multiply operator
    def multiply(self, other):
        return self.rtval.multiply('Vec2', other.rtval)

    # Overload method for the divide operator
    def divide(self, other):
        return self.rtval.divide('Vec2', other.rtval)

    # Returns the product of this vector and a scalar
    def multiplyScalar(self, other):
        return self.rtval.multiplyScalar('Vec2', KC.inst().rtVal('Scalar', other))

    # Returns the division of this vector and a scalar
    def divideScalar(self, other):
        return self.rtval.divideScalar('Vec2', KC.inst().rtVal('Scalar', other))

    # Returns the negated version of this vector
    def negate(self):
        return self.rtval.negate('Vec2')

    # Returns the inversed version of this vector
    def inverse(self):
        return self.rtval.inverse('Vec2')
    ...
    def clamp(self, min, max):
        return self.rtval.clamp('Vec2', min.rtval, max.rtval)
    ...
    def Scalar distanceTo(self, other):
    ...
    def linearInterpolate(self, other, t):
        return self.rtval.linearInterpolate('Vec2', KC.inst().rtVal('Scalar', t))
